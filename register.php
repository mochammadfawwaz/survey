...
<body background="">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#login" data-toggle="modal"><button class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-user"></span> Daftar</button></a></li>
                </ul>
            ...
            <div class="panel-body" style="background-color:#e6e6e6;">
                ...
                <div class="col-lg-12">
                    <p align="center" style="background-color:black; color:white;">
                        <font size="5">SURVEY KEPUASAN PELANGGAN</font>
                    </p>
                </div>
                <div class="row">
    ...
    <nav class="navbar navbar-inverse navbar-absolut-bottom" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <center>
                    <font color="white" size="1">Created By Wahyu Budiman</font>
                </center>
            </div>
            <!-- /.navbar-collapse -->
        </div>
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <button class="btn btn-primary" type="submit"><span class="glyphicon glyphicon-user"></span> Daftar</button>
                                </div>
                            </div>
                        </div>
                    </div>
