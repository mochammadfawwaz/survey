						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<div id="kontentd"><?php echo $r['username']; ?></div>
									</td>
									<td>
										<div id="kontentd"><?php echo $r['fullname']; ?></div>
									</td>
									<td>
										<div id="kontentd"><a href="mailto:<?php echo $r['email']; ?>"><?php echo $r['email']; ?></a>
									<td>
										<div id="kontentd"><?php echo $r['level']; ?></div>
									</td>
									<td>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form method="POST" action="<?php echo $aksi; ?>?module=user&act=input" onSubmit="return validasi(this)" class="form-horizontal">
						...
						<div class="form-group">
							<label for="nama" class="col-sm-2 control-label">Nomor Telepon</label>
							<div class="col-sm-5">
								<div class="input-group">
									<div class="input-group-addon">
										<span class="glyphicon glyphicon-tags"></span>
									</div>
									<input type="text" name="no_telephone" class="form-control" placeholder="Nomor Telepon">
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<select name="level" id="" class="form-control">
										<option value="Biasa">Admin</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="company" class="form-control" placeholder="Nama Perusahaan" value="<?php echo $r[company]; ?>">
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="position" class="form-control" placeholder="Jabatan" value="<?php echo $r[position]; ?>">
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="no_telephone" class="form-control" placeholder="Nomor Telepon" value="<?php echo $r[no_telephone]; ?>">
								</div>
							</div>
						</div>
						<div class="form-group">
